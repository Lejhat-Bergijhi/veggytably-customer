                ...
                child: Padding(
                          ...
                          Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10, ),
                             child: Row(
                              ...
                              children: [
                                Image.asset('assets/images/info.png', width: 22, height: 22,),
                                SizedBox(width:10),
                                Column(
                  ...
                  Text(
                   ...
                   Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset('assets/images/merchantlogo.png', width: 35, height: 35,),
                        SizedBox(width:12),
                        Column(
                        crossAxisAlignment: CrossAxisAlignment.start,  
                        children: [
                        ...
                        Spacer(),
                        Image.asset('assets/images/message.png', width: 17.14, height: 17.14,),
                         SizedBox(width: 13.71),
                        Image.asset('assets/images/call.png', width: 17.14, height: 17.14,),
                  ...
                  Text(
                   ...
                   Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset('assets/images/driverlogo.png', width: 35, height: 35,),
                        SizedBox(width:12),
                        Column(
                        crossAxisAlignment: CrossAxisAlignment.start,  
                        children: [
